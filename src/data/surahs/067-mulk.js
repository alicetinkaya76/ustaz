    ...
    verses: [
      {
        ...
        words: [
          ...
          { arabic: "بِيَدِهِ", transliteration: "bi-yadihi", root: "ي-د-ي", pattern: null, pos: "ism", meaning_tr: "elinde", irab: "بِ {harf-i cer} + يَد {mecrûr, muzâf} + هِ {muzâfun ileyh}. Câr-mecrûr = {haber mukaddem} (الْمُلْكُ'ün haberi). Sıla cümlesinin bir parçası.", irab_short: "câr-mecrûr, haber mukaddem", turkish_bridge: "Yed (el), yedek bu kökten", balagha_note: "بِيَدِهِ: mecâz — Allah'ın kudreti ve tasarrufunu 'el' ile ifade → isti'âre." },
          { arabic: "الْمُلْكُ", transliteration: "al-mulku", root: "م-ل-ك", pattern: "فُعْل", pos: "ism", meaning_tr: "hükümranlık, mülk", irab: "{Mübtedâ muahhar}, {merfû} (damme). Haber (بِيَدِهِ) öne geçmiş. Sıla cümlesinin bir parçası.", irab_short: "mübtedâ muahhar, merfû", turkish_bridge: "Melik, mülk, memleket, mâlik hep bu kökten", balagha_note: "Surenin adı bu kelimedir — mutlak hâkimiyet." },
      ...
      },
      {
        ...
        words: [
          ...
          { arabic: "طِبَاقًا", transliteration: "ṭibāqan", root: "ط-ب-ق", pattern: "فِعَال", pos: "ism", meaning_tr: "tabaka tabaka, üst üste", irab: "{Hâl} veya {sıfat} (سَمَاوَات için), veya {mef'ûl mutlak} (= خَلْقًا طِبَاقًا takdîrinde), {mensûb}. طَبَقَ: uyum, tabaka.", irab_short: "hâl/sıfat/mef'ûl mutlak, mensûb", turkish_bridge: "Tabak, tabaka, tetâbuk (uyum) bu kökten" },
          ...
          { arabic: "تَفَاوُتٍ", transliteration: "tafāwutin", root: "ف-و-ت", pattern: "تَفَاعُل", pos: "ism", meaning_tr: "uyumsuzluk, çelişki", irab: "Lafzen {mecrûr} (مِنْ ile); mahallen {mensûb} (مِنْ zâide olduğu için gerçek i'rab mef'ûl bih). VI. bâb masdarı: karşılıklı ayrışma, tutarsızlık.", irab_short: "mecrûr lafzen, mensûb mahallen", turkish_bridge: "Tefâvüt (fark), fevt (kaçırma) bu kökten" },
          ...
          { arabic: "فُطُورٍ", transliteration: "fuṭūrin", root: "ف-ط-ر", pattern: "فُعُول", pos: "ism", meaning_tr: "çatlak, yarık", irab: "Lafzen {mecrûr} (مِنْ zâide ile); mahallen {mensûb} (مef'ûl bih). فَطَرَ: yardı → فُطُور: yarık, çatlak.", irab_short: "mecrûr lafzen, mensûb mahallen", turkish_bridge: "Fıtrat (yaratılış = yarıp açma), iftar (orucu yarma) bu kökten", balagha_note: "İstifhâm-ı inkârî: 'çatlak görebilir misin?' = 'asla göremezsin!' Soru formuyla kesinlik." },
        ],
      },
      {
        surah: 67, ayah: 4,
    ...
    verses: [
      {
        ...
        words: [
          ...
          { arabic: "عَذَابُ", transliteration: "ʿaḏābu", root: "ع-ذ-ب", pos: "ism", meaning_tr: "azabı", irab: "{Mübtedâ muahhar}, {merfû}. Câr-mecrûr (لِلَّذِينَ) haber-i mukaddem.", irab_short: "mübtedâ muahhar, merfû" },
